    ...
    public int[] findBestBlackMoves(int lookAhead, int movesToConsider) {
        ...
        if (lookAhead>0)
        {
            for (int i = 0;i < size; i++)
            {
                ...
                String notationDEBUG = e.getNotation();
//                System.out.println(notationDEBUG + " "+ e + "-------------------");
                int[] whiteMoves = e.boardAfterMove.findBestWhiteMoves(0, 1, notationDEBUG);
                ...
                {
                    System.out.println("No white move!");
                }
            }
            Collections.sort(bestEvaluatedMoves);
        }
    ...
    public int[] findBestWhiteMoves(int lookAhead, int movesToConsider, String notationDEBUG) {
        ...
        for (int i = 0; i < movesToConsider && i < size; i++) {
            ...
            System.out.println("  " + notationDEBUG + " " + evaluatedMoves.get(i).getNotation() + " " + evaluatedMoves.get(i));
        }
        return bestMoves;
    }
